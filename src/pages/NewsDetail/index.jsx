        ...
        return (
            <>
                <Card className={index.card}>
                    <Title className={index.title} level={2}>{news[id - 1].title}</Title>
                    <Paragraph className={index.date}>{news[id - 1].date}</Paragraph>
                    <Divider/>
                    {news[id - 1].content.map((d, i) => {
                        return (
                            <p key={i} className={index.content}>{d}</p>
                        )
                    })}
                    <Divider/>
                    {nextPage[0].title === '无' ? <Paragraph>已经是第一篇了</Paragraph> :
                        <div className={index.linkDiv}><Link href={nextPage[0].url}>上一篇：{nextPage[0].title}</Link></div>}
                    {nextPage[1].title === '无' ? <Paragraph>已经是最后一篇了</Paragraph> :
                        <div className={index.linkDiv}><Link className={index.link} href={nextPage[1].url}>下一篇：{nextPage[1].title}</Link></div>}
